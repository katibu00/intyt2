...
Route::group(['prefix' => 'settings', 'middleware' => ['auth', 'admin']], function(){
    ...
    Route::get('/branches/index', [SettingsController::class, 'branchIndex'])->name('branches.index');
    Route::post('/branches/store', [SettingsController::class, 'branchStore'])->name('branches.store');
    Route::get('/branches/edit/{id}', [SettingsController::class, 'branchEdit'])->name('branches.edit');
    Route::post('/branches/update/{id}', [SettingsController::class, 'branchUpdate'])->name('branches.update');
